...
<head>
<meta charset="utf-8">
<title>الملفات التعريفية عن خدمات المجموعة </title>
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الملفات التعريفية عن خدمات المجموعة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الملفات التعريفية عن خدمات المجموعة</span>
									</div>
								</div>
...
<form action="<?=$url;?>admin/files/delete_product" method="POST" id="form">
								...
								$main_file=DIR."uploads/files/".$img; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td><?=$title_ar;?></td>
												<td> <?=$title_eng;?> </td>
										<td><a href="<?= $main_file?>" target="_blank">File Link</a> </td>
...
<li><a href="<?php echo base_url()?>admin/files/update_files?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
<li><a href="<?php echo base_url()?>admin/files/delete_product?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_files");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/files/check_view_files") ?>',
                type: 'POST',
                data: data,				
