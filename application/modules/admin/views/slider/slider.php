			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الاسليدر</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الاسليدر</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/delete_slider" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('slider')->result();
										 if(count($tt)>0){
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=substr($name_ar,0,80);?> </td>
												<td><?=substr($name,0,80);?></td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/update_slider?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/delete_slider?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
