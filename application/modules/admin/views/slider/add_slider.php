                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                             ...
                                             <input type="text" placeholder="Title" class="form-control" style="text-align:left" name="title_eng">
                                                                <!--<span class="help-block"> This is inline help </span>-->
															</div>
															<div class="col-md-2"></div>
                                                        </div>
														...
														<div class="col-md-2"></div>
															...
															<textarea class="form-control autosizeme" rows="4" placeholder="التفاصيل" data-autosize-on="true"
															 style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 60px;" name="description_ar"></textarea>															</div>
															<div class="col-md-2"></div>
                                                        </div>
														...
														<div class="col-md-2"></div>
															...
															<textarea class="form-control autosizeme" rows="4" placeholder="Description" data-autosize-on="true"
															 style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 60px;text-align:left" name="description_eng"></textarea>															</div>
															<div class="col-md-2"></div>
                                                        </div>
