...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
						...
						<div class="col-md-12">
							...
							<div class="profile-content">
                                ...
                                <input type="text"  style="text-align:left" placeholder="Title" class="form-control" value="<?= $regulations_title_intro_en?>" name="title_eng">
												...
												<textarea  name="team_work_intro_ar" class="form-control autosizeme" data-autosize-on="true" style="resize: horizontal; height: 60px;" id="team_work_intro_ar"><?=$regulations_intro_ar;?></textarea>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> Context </span>
																			<textarea class="form-control autosizeme" name="team_work_intro_en"  data-autosize-on="true" style="resize: horizontal; height: 60px;" id="team_work_intro_en"><?=$regulations_intro_en;?></textarea>
																			<!-- <?php //echo $this->ckeditor->editor("description","description");?> -->
	...
	var about_site = CKEDITOR.replace( 'team_work_intro_en' );
	var about_site_ar = CKEDITOR.replace( 'team_work_intro_ar' );
