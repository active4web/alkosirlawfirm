			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">انظمة ولوائح</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">انظمة ولوائح</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/regulations/delete_regulations" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('systems_regulations')->result();
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												/*$image=$data->img;
												$base=base_url();
												$img=$base."uploads/systems_regulations/".$image;*/
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td><?=$title_ar;?></td>
												<td> <?=$title_eng;?> </td>
												<td><a title="مشاهدة  الرابط"  href="<?php echo $link;?>" target="_blank">الرابط</a></td>
												<td><a title="Link"  href="<?php echo $link_en;?>" target="_blank">Link</a></td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/regulations/update_regulations?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/regulations/delete_regulations?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("<?= base_url()?>admin/regulations/add_regulation");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/regulations/check_view_regulation") ?>',
                type: 'POST',
                data: data,				
