                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="profile-content">
                                ...
                                <input type="text"  style="text-align:right" placeholder="الرابط" class="form-control" name="link">
                                ...
                                <input type="text"  style="text-align:left" placeholder="Link" class="form-control" name="link_en">
                                </div><div class="col-md-2">
                                </div></div>
