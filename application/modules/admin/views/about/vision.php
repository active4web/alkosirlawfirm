			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الرؤية صفحة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i> تعديل الرؤية  </div>
													...
													<div class="portlet light bordered form-fit">
														...
														<?php
															foreach($site_info as $result){
																$about_site = $result->vision_site;
																$about_site_ar = $result->vision_site_ar;
																$about_img = $result->vision_img;
															}
														?>
															...
															<div class="col-md-3" style="text-align:center"></div>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> المحتوي </span>
																			<textarea id="about_site_ar" name="vision_site_ar" id="about_site_ar"><?=$about_site_ar;?></textarea>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> Context </span>
																			<textarea id="about_site" name="vision_site" id="about_site"><?=$about_site;?></textarea>
																			<!-- <?php //echo $this->ckeditor->editor("description","description");?> -->
