															...
															<div class="col-md-3" style="text-align:center"></div>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> المحتوي </span>
																			<textarea id="about_site_ar" name="about_site_ar" id="about_site_ar"><?=$about_site_ar;?></textarea>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> Context </span>
																			<textarea id="about_site" name="about_site" id="about_site"><?=$about_site;?></textarea>
																			<!-- <?php //echo $this->ckeditor->editor("description","description");?> -->
