...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
  ...
  $this->session->userdata('adminlname');
  $this->session->userdata('adminphone');
                                                            <span class="help-block"><?=lang('email');?></span>
                                                                <input type="text" placeholder="<?=lang('email');?>" class="form-control" name="mail" value="<?=  $this->session->userdata('adminmail');?>">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block"><?=lang('username');?></span>
                                                                <input type="text" placeholder="<?=lang('username');?>" class="form-control" name="username" value="<?=  $this->session->userdata('adminusername');?>">
