                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="profile-content">
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                <form action="<?=$url;?>admin/teamwork/product_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
                                                    <div class="form-body">
                                        ...
                                        <input type="radio" style="height:20px;float:right;width:80px;" name="job_type" value="1" class="form-control" >شريك</span>
                                                            <span style="float:right">
                                        <input type="radio" style="height:20px;float:right;width:80px;" name="job_type" value="2" class="form-control"  checked >غير ذلك
                                        </span>
															</div>
															<div class="col-md-2"></div>
                                                        </div>
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block">الأسم</span>
                                                                <input type="text" placeholder="الأسم" class="form-control" name="title_ar">
                                ...
                                <input type="text"  style="text-align:left" placeholder="Name" class="form-control" name="title_eng">
                                                                <!--<span class="help-block"> This is inline help </span>-->
															</div>
															<div class="col-md-2"></div>
                                                        </div>
														...
														<div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                            <span class="help-block" style="float:right">الوظيفة</span>
