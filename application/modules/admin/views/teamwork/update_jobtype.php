...
$id = $result->id;
$title_eng = $result->name_en;
$title_ar = $result->name_ar;
}
		...
		<div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
                        <a href="<?=$url.'admin/teamwork';?>">الوظائف المتاحة</a>
                        <i class="fa fa-circle"></i>
						</li>
                        <li>
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
    <form action="<?=$url;?>admin/teamwork/edit_typeaction" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
