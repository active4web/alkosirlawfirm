		...
		<div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
                        <a href="<?=$url.'admin/faq';?>">الانجازات</a>
                        <i class="fa fa-circle"></i>
						</li>
                        <li>
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
    <form action="<?=$url;?>admin/faq/edit_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
											        ...
											        <div class="form-body">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block">العنوان</span>
                                                                <input type="text"  value="<?= $title_ar?>" placeholder="العنوان" class="form-control" name="title_ar">
                                ...
                                <input type="text"  style="text-align:left" value="<?= $title_eng?>" placeholder="Title" class="form-control" name="title_eng">
                                                                <!--<span class="help-block"> This is inline help </span>-->
															</div>
															<div class="col-md-2"></div>
                                                        </div>
														...
														<div class="form-group">
																		...
																		<span class="help-block" style="padding:20px;">الأنجازات</span>
																	...
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-12" style="text-align:center">
																		<span class="help-block" style="padding:20px;">Achievements</span>
