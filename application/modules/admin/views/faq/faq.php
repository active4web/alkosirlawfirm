			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الأنجازات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الأنجازات</span>
									</div>
								</div>
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="btn-group">
												<a href="<?= DIR?>admin/faq/mainimg">
										
													<button id="sample_editable_1_2_new" class="btn sbold green "> صورة الانجازات
									...
									<form action="<?=$url;?>admin/faq/delete_faq" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('achievements_text')->result();
										 if(count($tt)>0){
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												?>
												<td><?= mb_substr($title_ar,0,20)."...";?></td>
												<td> <?= mb_substr($title_eng,0,20)."...";?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/faq/update_faq?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/faq/delete_faq?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("<?= base_url()?>admin/faq/add_faq");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/faq/check_view_faq") ?>',
                type: 'POST',
                data: data,				
