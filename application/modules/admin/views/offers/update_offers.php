...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        <div class="portlet box blue ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>تعديل عرض</div>
                                            </div>
    ...
    <form action="<?=$url;?>admin/offers/edit_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
											        ...
											        <div class="form-body">
														...
														<div class="col-md-3" style="text-align:center"></div>
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																				<img src="<?=$url;?>uploads/offers/<?=$image;?>" alt="" /> </div>
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block">عنوان العرض</span>
                                                                <input type="text"  value="<?= $title_ar?>" placeholder="عنوان العرض" class="form-control" name="title_ar">
                                ...
                                <input type="text"  style="text-align:left" value="<?= $title_eng?>" placeholder="Offer title" class="form-control" name="title_eng">
                                                                <!--<span class="help-block"> This is inline help </span>-->
															</div>
															<div class="col-md-2"></div>
                                                        </div>
