                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                <form action="<?=$url;?>admin/offers/product_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
                                                    <div class="form-body">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block"> عنوان العرض</span>
                                                                <input type="text" placeholder="عنوان العرض" class="form-control" name="title_ar">
														...
														<div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                            <span class="help-block" style="float:left">Offer title</span>
                                <input type="text"  style="text-align:left" placeholder="Offer title" class="form-control" name="title_eng">
                                                                <!--<span class="help-block"> This is inline help </span>-->
															</div>
															<div class="col-md-2"></div>
                                                        </div>
