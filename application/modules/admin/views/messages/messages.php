									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$mail;?> </td>
												<td><?=$data->phone;?></td>
												<td> <a href="<?= base_url()?>admin/view_message?id=<?= $data->id_message;?>">التفاصيل</a></td>
												<td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/messages/delete_message?id=<?= $data->id_message;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/messages/check_view_message") ?>',
                type: 'POST',
                data: data,				
