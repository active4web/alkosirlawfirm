...
$file_name="file";
$config=get_img_config('site_info','uploads/site_setting/',$file,$file_name,'about_img','gif|jpg|png|jpeg',600000,600000,600000,array('id'=>1),"450","350");
}
...
$file=$_FILES['file']['name'];
$file_name="file";
$config=get_img_config('site_info','uploads/site_setting/',$file,$file_name,'vision_img','gif|jpg|png|jpeg',600000,600000,600000,array('id'=>1),"450","350");
}

$this->session->set_flashdata('msg', 'تم التعديل بنجاحٍ');
$this->session->mark_as_flash('msg');
//$this->session->mark_as_temp('msg',40);
