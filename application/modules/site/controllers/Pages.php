			 ...
			 <table cellspacing='0' cellpadding='0' width='600' class='w320'>
			   <tr>
				 <td style='padding:5px 0 25px' class='free-text headerlgb1'>
				   &copy; جميع الحقوق محفوظة لدى شركة <a href='https://www.alkosirlawfirm.com'>مجموعة القصير والتركي للمحاماة</a>  <br />
				  <br /><br />
				 </td>
			   </tr>
			 </table>
		 ...
		 <td align='center' valign='top' width='100%'' style='background-color: #f7f7f7; height: 100px;'>
		   <center>
			 <table cellspacing='0' cellpadding='0' width='600' class='w320'>
			   <tr>
				 <td style='padding:5px 0 25px' class='free-text headerlgb1'>
				   &copy; جميع الحقوق محفوظة لدى شركة <a hre='https://www.alkosirlawfirm.com'>مجموعة القصير والتركي للمحاماة</a>  <br />
				  <br /><br />
				 </td>
			   </tr>
			 </table>
...
$body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	$this->session->set_flashdata('msg',lang('sendmessage_result_send'));
	$this->session->mark_as_flash('msg');
