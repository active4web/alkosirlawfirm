...
$last_service=	$this->db->get_where("site_info")->result();
foreach($last_service as $meta_words)
?>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="<?= $meta_words->description?>" name="description" />
        <meta content="<?= $meta_words->keywords?>" name="keywords" />
